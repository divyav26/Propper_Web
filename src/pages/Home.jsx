    ...
    <Layout>
      ...
      <div className="relative">
        <img
          src={Background2}
          alt="Background2"
          className="h-[80vh] lg:h-[50vh] w-full bg-black bg-opacity-70 object-cover"
        />
        <div className="bg-black bg-opacity-70 absolute inset-0" />

        <div className="absolute top-10 left-0 right-0 lg:flex lg:justify-between lg:px-[100px]">
          <div className="flex-col items-center mr-15">
            ...
            />
            <h1 className="text-white font-bold text-lg lg:mb-4 lg:mt-9 ml-6 lg:ml-14">
              Modern & Safe Living
            </h1>
