...
var Data = [
  {
    id:1,
    img:require('../img/gallery-big-04.jpg'),
    content:'Sed vel lorem et dictum rhoncus egrt orci. Vestibulum ante ipsum primis in faucibus orci luctus et.',
    author: '__JOHN DOE',
    sub_title:'River Side Apartments',
  },
  {
    id:1,
    img:require('../img/gallery-01.jpg'),
    content:'Sed vel lorem et dictum rhoncus egrt orci. Vestibulum ante ipsum primis in faucibus orci luctus et.',
    author: '__PETER BROWN',
    sub_title:'LTJ Investments',
  },
  {
    id:1,
    img:require('../img/gallery-02.jpg'),
    content:'Sed vel lorem et dictum rhoncus egrt orci. Vestibulum ante ipsum primis in faucibus orci luctus et.',
    author: '__SUZANE J.BRIGHT',
    sub_title:'Archits Compan',
  },
]
...
const Pricing = () => {
  ...
  return (
    ...
    <div className="px-3">
      <div className="lg:px-[80px] px-2 py-2 lg:py-[60px]">
        <div className="lg:flex justify-between mt-10">
          ...
          <div className="flex flex-col text-center p-5 lg:w-[25%] sm:w-[38vh]  border-[12px] mt-4 border-gray-100">
          ...
          <div className="flex flex-col text-center lg:w-[25%] sm:w-[38vh] mt-4 border-[12px] border-gray-200">
            <div className="items-center lg:ml-6 ml-[50px] px-5">
              <header className="text-xs w-full text-white bg-peacock-green text-center">
          ...
          <div className="flex flex-col text-center p-5 lg:w-[25%]  sm:w-[38vh] mt-4 border-[12px] border-gray-200">
            <h3 className="text-2xl mt-6 font-bold">
              4 Room
              <br /> Apartment
      ...
      <div className="lg:px-[80px] px-2">
        <h1 className="text-3xl font-bold mt-20 lg:mb-10 mb-4">FAQ</h1>
