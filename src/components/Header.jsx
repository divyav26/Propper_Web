...
const Header = () => {
  ...
  return (
    <div className="">
    <header
      className={`fixed z-10 w-full flex justify-between p-2 items-center bg-black transition duration-300 ${
        isScrolled ? "bg-black" : ""
      }`}
    >
      <div className="flex w-full items-center justify-between px-[20px] py-[1px] lg:container lg:mx-auto lg:px-10">
        <Link
          to="/"
        ...
        <div className="hidden justify-between items-center lg:flex lg:w-auto">
          <ul className="lg:flex gap-x-4 hidden cursor-pointer">
            ...
            <li>
              <NavLink
                to="/about"
                className="text-sm font-bold block lg:inline-block z-10 relative text-white hover:text-blue-50"
              >
                About
              </NavLink>
            </li>
        ...
        <div className="fixed text-gray-400 left-0 top-0 w-full h-screen bg-black/70 px-9 py-[50px] flex-col z-10">
          <ul className="flex flex-col fixed w-full h-full items-center ml-20 mt-4">
            <li>
              <NavLink
                to="/"
                className="text-2xl font-bold block lg:inline-block p-2 z-10 relative underline text-white hover:text-blue-50"
              >
                Home
              </NavLink>
            </li>
